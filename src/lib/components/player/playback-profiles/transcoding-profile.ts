...
import { getSupportedMP4VideoCodecs, hasVp8Support } from './helpers/mp4-video-formats.ts';
import {
	canPlayNativeHls,
	canPlayHlsWithMSE,
	hasMkvSupport
...
import type { JellyfinTranscodingProfile } from '@reiverr/connectors/types/jellyfin';
...
): Array<JellyfinTranscodingProfile> {
